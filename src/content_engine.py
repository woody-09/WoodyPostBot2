...
class ContentEngine:
    ...
    def generate_content(self, topic):
        ...
        - **사견 및 통찰**: 글의 흐름에 당신의 주관적인 사견을 자연스럽게 섞는다. 이는 불확실한 인사이트여도 괜찮다.
           ...
           - **캐주얼한 취소선**: 사견을 적는 도중 "에잇 몰라...", "귀찮다..."와 같이 **일부러 매우 대충 쓴 것 같은 느낌의 캐주얼한 문장**을 한 문장 정도 추가하고, 해당 문장은 반드시 `<del>` 태그로 감싸서 취소선 처리한다.
        ...
        3. **Reader Centric**: 정보 전달 최우선, 과도한 장식 배제
